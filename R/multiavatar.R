# This R script is written by Peter Solymos based on the following code:
#
...
themes = list(
    ...
    "02" = list(
        "A" = list(
            ...
            "mouth" = c("#d12823"),
            "eyes" = c("#000", "none"),
            "top" = c("#000", "none", "none",  "#FFCC00", "red")
        ),
        "B" = list(
            "env" = c("#ff9700"),
            "clo" = c("#000"),
            ...
            "mouth" = c("#000"),
            "eyes" = c("#000", "#00ffdc"),
            "top" = c("#fdff00", "#fdff00", "none", "none", "none")
        ),
        "C" = list(
            "env" = c("#26a7ff"),
            "clo" = c("#d85cd7"),
            ...
            "eyes" = c("#000", "magenta"),
            # "eyes" = c("#000", "#ff0000"),
            "top" = c("#FFCC00", "#FFCC00", "#FFCC00", "#ff0000", "yellow")
        )
    ),
    ...
    "03" = list(
        "A" = list(
            "env" = c("#6FC30E"),
            "clo" = c("#b4e1fa", "#5b5d6e", "#515262", "#a0d2f0", "#a0d2f0"),
            "head" = c("#fae3b9"),
            "mouth" = c("#fff", "#000"),
            "eyes" = c("#000"),
            "top" = c("#8eff45", "#8eff45", "none", "none")
        ),
        "B" = list(
            "env" = c("#00a58c"),
            "clo" = c("#000", "none", "none", "none", "none"),
            "head" = c("#FAD2B9"),
            "mouth" = c("#fff", "#000"),
            "eyes" = c("#000"),
            "top" = c("#FFC600", "none", "#FFC600", "none")
        ),
        "C" = list(
            "env" = c("#ff501f"),
            "clo" = c("#000", "#ff0000", "#ff0000", "#7d7d7d", "#7d7d7d"),
            "head" = c("#fff3dc"),
            "mouth" = c("#d2001b", "none"),
            "eyes" = c("#000"),
            "top" = c("#D2001B", "none", "none", "#D2001B")
        )
    ),
    ...
    "04" = list(
        "A" = list(
            "env" = c("#fc0"),
            "clo" = c("#901e0e", "#ffbe1e", "#ffbe1e", "#c55f54"),
            "head" = c("#f8d9ad"),
            "mouth" = c("#000", "none", "#000", "none"),
            "eyes" = c("#000"),
            "top" = c("#583D00", "#AF892E", "#462D00", "#a0a0a0")
        ),
        "B" = list(
            "env" = c("#386465"),
            "clo" = c("#fff", "#333", "#333", "#333"),
            "head" = c("#FFD79D"),
            "mouth" = c("#000", "#000", "#000", "#000"),
            "eyes" = c("#000"),
            "top" = c("#27363C", "#5DCAD4", "#314652", "#333")
        ),
        "C" = list(
            "env" = c("#DFFF00"),
            "clo" = c("#304267", "#aab0b1", "#aab0b1", "#aab0b1"),
            "head" = c("#e6b876"),
            "mouth" = c("#50230a", "#50230a", "#50230a", "#50230a"),
            "eyes" = c("#000"),
            "top" = c("#333", "#afafaf", "#222", "#6d3a1d")
        )
    ),
    ...
    "05" = list(
        "A" = list(
            "env" = c("#a09300"),
            "clo" = c("#c7d4e2", "#435363", "#435363", "#141720", "#141720", "#e7ecf2", "#e7ecf2"),
            "head" = c("#f5d4a6"),
            "mouth" = c("#000", "#cf9f76"),
            "eyes" = c("#000", "#000", "#000", "#000", "#000", "#000", "#fff", "#fff", "#fff", "#fff", "#000", "#000"),
            "top" = c("none", "#fdff00")
        ),
        "B" = list(
            "env" = c("#b3003e"),
            "clo" = c("#000", "#435363", "#435363", "#000", "none", "#e7ecf2", "#e7ecf2"),
            "head" = c("#f5d4a6"),
            "mouth" = c("#000", "#af9f94"),
            "eyes" = c("#9ff3ff;opacity:0.96", "#000", "#9ff3ff;opacity:0.96", "#000", "#2f508a", "#000", "#000", "#000", "none", "none", "none", "none"),
            "top" = c("#ff9a00", "#ff9a00")
        ),
        "C" = list(
            "env" = c("#884f00"),
            "clo" = c("#ff0000", "#fff", "#fff", "#141720", "#141720", "#e7ecf2", "#e7ecf2"),
            "head" = c("#c57b14"),
            "mouth" = c("#000", "#cf9f76"),
            "eyes" = c("none", "#000", "none", "#000", "#5a0000", "#000", "#000", "#000", "none", "none", "none", "none"),
            "top" = c("#efefef", "none")
        )
    ),
    ...
    "06" = list(
        "A" = list(
            ...
            "mouth" = c("#fff", "#000"),
            "eyes" = c("#000"),
            "top" = c("#000","#000","none", "#000", "#ff4e4e", "#000")
        ),
        "B" = list(
            "env" = c("#00d2a3"),
            "clo" = c("#0D0046", "#ffce73"),
            ...
            "mouth" = c("#000", "none"),
            "eyes" = c("#000"),
            "top" = c("#000","#000","#000", "none", "#ffb358",  "#000", "none", "none")
        ),
        "C" = list(
            "env" = c("#ff184e"),
            "clo" = c("#000", "none"),
            ...
            "mouth" = c("#ff0000", "none"),
            "eyes" = c("#000"),
            "top" = c("none","none","none", "none", "none",  "#ffc107", "none", "none")
        )
    ),
    ...
    "07" = list(
        "A" = list(
            ...
            "head" = c("#ffce94"),
            "mouth" = c("#f73b6c", "#000"),
            "eyes" = c("#e91e63", "#000", "#e91e63", "#000", "#000", "#000"),
            "top" = c("#dd104f", "#dd104f", "#f73b6c", "#dd104f")
        ),
        "B" = list(
            "env" = c("#181284"),
            "clo" = c("#491f49", "#ff9809", "#491f49"),
            "head" = c("#f6ba97"),
            "mouth" = c("#ff9809", "#000"),
            "eyes" = c("#c4ffe4", "#000", "#c4ffe4", "#000", "#000", "#000"),
            "top" = c( "none", "none", "#d6f740", "#516303")
        ),
        "C" = list(
            "env" = c("#bcf700"),
            "clo" = c("#ff14e4", "#000", "#14fffd"),
            "head" = c("#7b401e"),
            "mouth" = c("#666", "#000"),
            "eyes" = c("#00b5b4", "#000", "#00b5b4", "#000", "#000", "#000"),
            "top" = c("#14fffd", "#14fffd", "#14fffd", "#0d3a62")
        )
    ),
    ...
    "09" = list(
        "A" = list(
            "env" = c("#4aff0c"),
            "clo" = c("#101010", "#fff", "#fff"),
            "head" = c("#dbbc7f"),
            "mouth" = c("#000"),
            "eyes" = c( "#000", "none", "none"),
            "top" = c("#531148", "#531148", "#531148", "none")
        ),
        "B" = list(
            "env" = c("#FFC107"),
            "clo" = c("#033c58", "#fff", "#fff"),
            "head" = c("#dbc97f"),
            "mouth" = c("#000"),
            "eyes" = c("none", "#fff", "#000"),
            "top" = c("#FFEB3B", "#FFEB3B", "none", "#FFEB3B")
        ),
        "C" = list(
            "env" = c("#FF9800"),
            "clo" = c("#b40000", "#fff", "#fff"),
            "head" = c("#E2AF6B"),
            "mouth" = c("#000"),
            "eyes" = c("none", "#fff", "#000"),
            "top" = c("#ec0000", "#ec0000", "none", "none")
        )
    ),
    ...
    "10" = list(
        "A" = list(
            "env" = c("#104c8c"),
            "clo" = c("#354B65", "#3D8EBB", "#89D0DA", "#00FFFD" ),
            "head" = c("#cc9a5c"),
            "mouth" = c("#222", "#fff"),
            "eyes" = c("#000", "#000"),
            "top" = c("#fff", "#fff", "none")
        ...
        "B" = list(
            "env" = c("#0DC15C"),
            "clo" = c("#212121", "#fff", "#212121", "#fff" ),
            "head" = c("#dca45f"),
            "mouth" = c("#111", "#633b1d"),
            "eyes" = c("#000", "#000"),
            "top" = c("none", "#792B74", "#792B74")
        ),
        "C" = list(
            "env" = c("#ffe500"),
            "clo" = c("#1e5e80", "#fff", "#1e5e80", "#fff"),
            "head" = c("#e8bc86"),
            "mouth" = c("#111", "none"),
            "eyes" = c("#000", "#000"),
            "top" = c("none", "none", "#633b1d")
        )
    ),
    ...
    "11" = list(
        "A" = list(
            "env" = c("#4a3f73"),
            "clo" = c("#e6e9ee", "#f1543f", "#ff7058", "#fff", "#fff"),
            "head" = c("#b27e5b"),
            "mouth" = c("#191919", "#191919"),
            "eyes" = c("#000", "#000", "#57FFFD"),
            "top" = c("#ffc", "#ffc", "#ffc")
        ),
        "B" = list(
            "env" = c("#00a08d"),
            "clo" = c("#FFBA32", "#484848", "#4e4e4e", "#fff", "#fff"),
            "head" = c("#ab5f2c"),
            "mouth" = c("#191919", "#191919"),
            "eyes" = c("#000", "#ff23fa;opacity:0.39", "#000"),
            "top" = c("#ff90f4", "#ff90f4", "#ff90f4")
        ),
        "C" = list(
            "env" = c("#22535d"),
            "clo" = c("#000", "#ff2500", "#ff2500", "#fff", "#fff"),
            "head" = c("#a76c44"),
            "mouth" = c("#191919", "#191919"),
            "eyes" = c("#000", "none", "#000"),
            "top" = c("none", "#00efff", "none")
        )
    ),
    ...
    "12" = list(
        "A" = list(
            "env" = c("#2668DC"),
            "clo" = c("#2385c6", "#b8d0e0", "#b8d0e0"),
            "head" = c("#ad8a60"),
            "mouth" = c("#000", "#4d4d4d"),
            "eyes" = c("#7fb5a2", "#d1eddf", "#301e19"),
            "top" = c("#fff510", "#fff510")
        ),
        "B" = list(
            "env" = c("#643869"),
            "clo" = c("#D67D1B", "#b8d0e0", "#b8d0e0"),
            "head" = c("#CC985A", "none0000"),
            "mouth" = c("#000", "#ececec"),
            "eyes" = c("#1f2644", "#9b97ce", "#301e19"),
            "top" = c("#00eaff", "none")
        ),
        "C" = list(
            "env" = c("#F599FF"),
            "clo" = c("#2823C6", "#b8d0e0", "#b8d0e0"),
            "head" = c("#C7873A"),
            "mouth" = c("#000", "#4d4d4d"),
            "eyes" = c("#581b1b", "#FF8B8B", "#000"),
            "top" = c("none", "#9c0092")
        )
    ),
    ...
    "13" = list(
        "A" = list(
            "env" = c("#d10084"),
            "clo" = c("#efedee", "#00a1e0", "#00a1e0", "#efedee", "#ffce1c"),
            "head" = c("#b35f49"),
            "mouth" = c("#3a484a", "#000"),
            "eyes" = c("#000"),
            "top" = c("#000", "none", "#000", "none")
        ),
        "B" = list(
            "env" = c("#E6C117"),
            "clo" = c("#efedee", "#ec0033", "#ec0033", "#efedee", "#f2ff05"),
            "head" = c("#ffc016"),
            "mouth" = c("#4a3737", "#000"),
            "eyes" = c("#000"),
            "top" = c("#ffe900", "#ffe900", "none", "#ffe900")
        ),
        "C" = list(
            "env" = c("#1d8c00"),
            "clo" = c("#e000cb", "#fff", "#fff", "#e000cb", "#ffce1c"),
            "head" = c("#b96438"),
            "mouth" = c("#000", "#000"),
            "eyes" = c("#000"),
            "top" = c("#53ffff", "#53ffff", "none", "none")
        )
    ),
    ...
    "14" = list(
        "A" = list(
            "env" = c("#fc0065"),
            "clo" = c("#708913", "#fdea14", "#708913", "#fdea14", "#708913"),
            "head" = c("#DEA561"),
            "mouth" = c("#444", "#000"),
            "eyes" = c("#000"),
            "top" = c("#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f" )
        ),
        "B" = list(
            "env" = c("#81f72e"),
            "clo" = c("#ff0000", "#ffc107", "#ff0000", "#ffc107", "#ff0000"),
            "head" = c("#ef9831"),
            "mouth" = c("#6b0000", "#000"),
            "eyes" = c("#000"),
            "top" = c("#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "none", "none", "none", "none")
        ),
        "C" = list(
            "env" = c("#00D872"),
            "clo" = c("#590D00", "#FD1336", "#590D00", "#FD1336", "#590D00"),
            "head" = c("#c36c00"),
            "mouth" = c("#56442b", "#000"),
            "eyes" = c("#000"),
            "top" = c("#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "none", "none", "none", "none", "none", "none", "none", "none")
        )
    ),
    ...
    "15" = list(
        "A" = list(
            ...
            "head" = c("#755227"),
            "mouth" = c("#fff", "#000"),
            "eyes" = c("black", "#008;opacity:0.67", "aqua"),
            "top" = c("#fff", "#fff", "#fff", "#fff", "#fff")
        ),
        "B" = list(
            "env" = c("#00D0D4"),
            "clo" = c("#000", "#fff"),
            "head" = c("#755227"),
            "mouth" = c("#fff", "#000"),
            "eyes" = c("black", "#1df7ff;opacity:0.64", "#fcff2c"),
            "top" = c("#fff539", "none", "#fff539", "none", "#fff539")
        ),
        "C" = list(
            "env" = c("#DC75FF"),
            "clo" = c("#000", "#FFBDEC"),
            "head" = c("#997549"),
            "mouth" = c("#fff", "#000"),
            "eyes" = c("black", "black", "aqua"),
            "top" = c("#00fffd", "none", "none", "none", "none")
        )
    )
)
...
getFinal = function(part, partV, theme) {
        colors = themes[[partV]][[theme]][[part]]
        svgString = sP[[partV]][[part]]

        regex = '\\#(.*?)\\;'
        result = regmatches(svgString, gregexpr(regex, svgString, perl=TRUE))

        resultFinal = svgString

        if (length(result) > 0) {
            for (i in seq_along(result[[1]])) {
                resultFinal = gsub(result[[1]][i], paste0(colors[i], ";"), resultFinal)
            }
        }
...
#' 
#' Pass any string to the 'multiavatar' function. It will return the SVG code for the avatar.
#' 
...
#' @param ver Pass an object to force a specific initial version, for example: `multiavatar('test', FALSE, list('part' = '01', 'theme' = 'A'))`.
#' 
#' @return A string with the SVG code for the avatar.
#' 
#' @example 
#' svgCode = multiavatar("Binx Bond", FALSE, NULL)
#' print(svgCode)
#' # This should produce the same as the API
#' test = readLines(url("https://api.multiavatar.com/Binx%20Bond.svg"), warn = FALSE)
#' stopifnot(svgCode == test)
#' 
#' avatarId = "ANY_STRING"
#' svgCode = multiavatar(avatarId, TRUE, list("part" = "11", "theme" = "C" ))
multiavatar = function(string = '', sansEnv = FALSE, ver = NULL) {
    ...
    hash = substr(sha256Numbers, 1, 12)

    hash = sapply(1:12, function(z) substr(hash, z, z))

    # Get parts (range 0-47)
    p <- list()
    p['env'] = hash[1] %+% hash[2]
    p['env'] = as.character(round((47/100)*as.integer(p['env'])))
    p['clo'] = hash[3] %+% hash[4];
    p['clo'] = as.character(round((47/100)*as.integer(p['clo'])))
    p['head'] = hash[5] %+% hash[6]
    p['head'] = as.character(round((47/100)*as.integer(p['head'])))
    p['mouth'] = hash[7] %+% hash[8];
    p['mouth'] = as.character(round((47/100)*as.integer(p['mouth'])))
    p['eyes'] = hash[9] %+% hash[10];
    p['eyes'] = as.character(round((47/100)*as.integer(p['eyes'])))
    p['top'] = hash[11] %+% hash[12];
    p['top'] = as.character(round((47/100)*as.integer(p['top'])))

    # Get parts (range 1-16) + define themes
    for (part in names(p)) {
        nr <- as.integer(p[[part]])
        if (nr > 31) {
            nr <- as.character(nr - 32)
            if (nchar(nr) == 1)
                nr <- '0' %+% nr
            p[[part]] = c(nr, 'C')
        } else if (nr > 15) {
            nr <- as.character(nr - 16)
            if (nchar(nr) == 1)
                nr <- '0' %+% nr
            p[[part]] = c(nr, 'B')
        } else {
    ...
    final <- list()
    for (part in names(p)) {
        partV = if (is.null(ver))
            p[[part]][1] else ver[["part"]]
        theme = if (is.null(ver))
            p[[part]][2] else ver[["theme"]]
